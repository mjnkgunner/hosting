								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="chitietsanpham/{{$sp->id}}"><img src="source/image/product/{{$sp->image}}" alt="" height="250px"></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="chitietsanpham/{{$sp->id}}">Chi tiết  <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="themgiohang/{{$spk->id}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="chitietsanpham/{{$spk->id}}">Chi tiết  <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
