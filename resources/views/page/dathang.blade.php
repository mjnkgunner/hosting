				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text" id="name" name="name" value="{{Auth::user()->full_name}}" disabled="">
						</div>
						<div class="form-block">
						...
						<div class="form-block">
							...
							<input type="text" id="dob" name="dob" value="{{Auth::user()->dob}}" disabled="">
						...
						<div class="form-block">
							...
							<input type="text" id="adress" name="address" value="{{Auth::user()->address}}" disabled="">
						</div>
						...
						<div class="form-block">
							<label for="phone">Điểm tích luỹ*</label>
							<input type="text" id="phone" name="points" value="{{Auth::user()->points}}" disabled="">
						</div>
						<div class="form-block">
							<label for="promotion">Mã khuyến mãi*</label>
							<input type="text" id="promotion" name="promotion"  placeholder="Nhập mã khuyến mãi nếu có">
						</div>
						<div class="form-block">
					...
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input id="gender" type="radio" class="input-radio" name="gender" value="other" style="width: 10%"><span>Other</span>			
						</div>
					...
					<div class="col-sm-6">
						<div class="your-order">
							...
							<div class="your-order-body">
								<ul class="payment_methods methods">
									...
									<li class="payment_method_cheque">
										<input id="payment_method_cheque" type="radio" class="input-radio" name="payment_method" value="Online" data-order_button_text="">
										<label for="payment_method_cheque">Online</label>
										<div class="payment_box payment_method_cheque" style="display: none;">
											Thanh toán online qua VNPAY<br>
											Tất cả các loại thẻ trong nước và nội địa<br>
										</div>						
									</li>
							...
							@else
							<div class="text-center"><button type="submit" class="beta-btn primary" href="#" disabled="">Đặt hàng <i class="fa fa-chevron-right"></i></button></div>
							@endif
						</div> <!-- .your-order -->
					</div>
				</div>
