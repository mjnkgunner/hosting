                ...
                <div class="p-5">
                  ...
                  <form class="user">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Email của bạn...">
                    </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="dangnhap">Bạn đã có tài khoản? Đăng nhập!</a>
                  </div>
                </div>
              </div>
            </div>
